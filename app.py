...
based on various academic characteristics.
""")
...
with st.form("user_inputs"):
    st.subheader("UCLA Admissions Details")
...
# dummy variables to pass to the model
if submitted:
    ...
    prediction_input = [[GRE_Score, TOEFL_Score, University_Rating_1, University_Rating_2,
    ...
    if new_prediction[0] == 1:
        st.write("You have a chance to get into UCLA!")
    else:
        st.write("Sorry, you don't have a chance for UCLA.")

st.write(
    """I used a machine learning (Neural Network) model to predict your chance of admission to UCLA."""
)
